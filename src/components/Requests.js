  ...
  return (
    <div className="Requests">
      ...
      <table cellSpacing="0">
        <thead>
          <tr>
            <td> Owner </td> <td> Address </td> <td> Gender </td>{" "}
            <td> Beds </td> <td> View More Details </td> <td> </td> <td> </td>{" "}
          </tr>{" "}
        </thead>{" "}
        <tbody>
          {" "}
          {requests.map((request) => {
            return (
              <tr>
                <td> {request.owner} </td> <td> {request.address} </td>{" "}
                <td> {request.gender} </td> <td> {request.beds} </td>{" "}
                <td>
                  <IconButton>
