...
export default function HouseOwnerCreateAcc() {
    ...
    return ( <
        ...
        h3 >
        Please Note that
        for your house to be listed your account has to be approved first <
        /h3> <
        p >
        <
        em >
        ...
        <
        TextField label = "Address Of House"
        multiline style = {
            { margin: 8 } }
        placeholder = "Address"
        ...
        FormHelperText >
        Gender
        for the desired students at your house <
        /FormHelperText> <
        /FormControl>

        <
        TextField label = "Total Number of available beds"
        className = { classes.textField }
        margin = "dense"
        type = "number" /
        >
        ...
        br / >
        <
        TextField label = "Price Per Month $USD "
        className = { classes.textField }
        margin = "dense" /
        >
        ...
        <
        em >
        Enter your email and a password of your choice below.Please take note of your password as it is the one that will be used
        for login once your account is approved <
        /em> <
        /p> <
        /div> <
        div >
        ...
        {
            showModal ? < LogInModal message = { message }
